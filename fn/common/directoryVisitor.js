...
function ListVisitor(onVisit) {
  onVisit = onVisit||{};
  this.onVisitFile = onVisit.onVisitFile||function (file) {}//console.log("onVisitFile default implementation : " + file.name)};
  this.onVisitDirectory = onVisit.onVisitDirectory||function (directory) {}//console.log("onVisitDirectory default implementation : " + directory.name)};
};
